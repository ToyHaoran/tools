...
; Minimize Window to Tray Menu，可替代Minime
; 此脚本会设置Win+H来隐藏任意的窗口, 让这些窗口成为脚本托盘菜单底部的条目. 
; 在菜单上选择相应的项目可以显示个别隐藏的窗口Win+U或全部显示.脚本退出 所有窗口都会自动显示.
...
; ⭐ Win+Shift+Z 隐藏当前窗口。This is the hotkey used to hide the active window:
g_Hotkey := "#+z" 

; ⭐ Win+Shift+A 取消隐藏上个窗口。This is the hotkey used to unhide the last hidden window:
g_UnHotkey := "#+a"  
